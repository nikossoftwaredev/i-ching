export const servicesInfo = [
  {
    title: "ΒΕΛΟΝΙΣΜΟΣ",
    tags: ["balance method", "electro acupuncture", "κινέζικος βελονισμος"],
    description:
  ...
  {
    title: "ΜΑΛΑΞΗ",
    tags: ["μόξα", "βεντούζες φωτιας", "βεντούζες σιλικονης"],
    description:
  ...
  {
    title: "ΡΥΘΜΙΣΗ ΒΑΡΟΥΣ",
    tags: ["διατροφη", "μαλαξη κυτταριτιδας"],
    description:
      "Συνταγογράφηση σύμφωνα με την κινέζικη ιατρική ως θεραπεία ή για απώλεια βάρους",
